...
class ProdukTokoViewHolder(
    private val notesList: MutableList<ProdukTokoModel>,
    private val context: Context
) : RecyclerView.Adapter<ProdukTokoViewHolder.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.list_produk_toko, parent, false)
